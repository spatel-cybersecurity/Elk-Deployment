...
![ELK Diagram](Diagram/HW-12-Network.JPG)
...
Answer: Metricbeat records metrics from the systems and services running on the server, and then ouput to Elasticsearch or Logstash.
...
Only the Jump box and Elkservermachine can accept connections from the Internet. Access to this machine is only allowed from the following IP addresses:
...
C:\Users\Jenie\Pictures\Screenshots\ 
